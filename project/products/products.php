                ...
                <div id="product-list">
                    ...
                    <div class="row">
                        ...
                        try {
                            ...
                            $product = Product::getProducts($start, $count, $type, $brandID, $catID);
                            ...
                            foreach ($product as $p) {
                                ...
                                <br>
                                <div>
                                    <a href='#'><img src='" . BASE_URL . "images/zoom.png' alt='zoom btn' width='52px' height='19px' class='zoom'></a>
                        ...
                        echo "<div class='row'><div class='col-xs-offset-2'>";
