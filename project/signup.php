        ...
        <div id="content" class="container">
            ...
            <section id="article-area" class="col-md-7 col-sm-9 col-xs-12">
                ...
                <div id="form-container">
                    ...
                    <form action="process/processSignup.php" method="post" enctype="multipart/form-data" id="signup-form">
                        ...
                        <div class="row">
                            ...
                            <div class="cell cell-right">
                                <input type="text" id="contactNumber" name="contactNumber" maxlength="16"   placeholder="Contact Number">
                                <span class="field-msg">
                                    <?php
                        ...
                        <div class="row">
                            <div class="cell cell-left">
                                <div class="cell cell-right"><a href="<?php echo (BASE_URL); ?>login.php">Login</a></div>
                            </div>
                            <div class="cell cell-right">
